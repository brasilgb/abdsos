...
<div class="card shadow-sm">
    ...
    <div class="card-body px-4 py-2">
            ...
            <form action="{{ route('usuarios.update', ['usuario' => $usuario->id]) }}" method="POST" autocomplete="off">
                @method('PUT')
                @csrf
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for=""><span class="text-danger">*</span>
                        Função:</label>
                    <div class="col-sm-7">
                        <select class="custom-select my-1 mr-sm-2" name="funcao"  @if($usuario->funcao == 0)  onchange="this.value = '0'" @endif>
                            @foreach ($funcao as $key => $value)
                                <option @if($usuario->funcao == $key) selected @endif value="{{ $key }}">{{ $value}}</option>
                            @endforeach
                        </select>
                        @error('funcao')
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for=""> Senha:</label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for="">Repita e senha:</label>
                    <div class="col-sm-7">
