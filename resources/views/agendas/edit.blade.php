...
<div class="card shadow-sm">
    ...
    <div class="card-body px-4 py-2">
        ...
        <form id="formagenda" action="{{ route('agendas.update', [$agenda->id_agenda]) }}" method="POST"
            autocomplete="off">
            @method('PUT')
            @csrf
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label" for=""><span class="text-danger">*</span>
                    Hora:</label>
                <div class="col-sm-7">
                    <input id="agendamento" type="text" class="form-control" name="hora"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <select class="custom-select my-1 mr-sm-2" name="status">
                        ...
                        <option value="{{ $key }}" {{ old('status', $key) == $agenda->status ? 'selected' : '' }}>
                            {{ $value }}
                        </option>
                        @endforeach
                    </select>
