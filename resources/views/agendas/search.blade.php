<div class="col">
    <form id="status" action="{{ route('agendas.busca') }}" method="POST" class="inline">
        @csrf
        @method('POST')
        <div class="input-group">
            <select class="w-75 custom-select" name="status" required>
...
<div class="col">
    <form id="form-search" action="{{ route('agendas.busca') }}" method="POST" class="inline">
        ...
        @method('POST')
        <div class="input-group">
            <input id="searchform" type="text" class="form-control rounded-left" name="term"
