            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <div class="input-group">
                        ...
                        <input id="inicial" type="text" name="valinicial" class="valinicial form-control rounded-0 col-xs-4"
                            value="@if($etiquetainicial) {{$etiquetainicial->id_ordem + 1}} @else 1 @endif">
                        ...
                        <div class="input-group-append">
                            <button @if(!$empresa) disabled @endif class="geraetiqueta rounded-right btn btn-primary"
                                type="submit"><i class="fa fa-tag"></i>
                                Gerar</button>
                        </div>
                    </div>
                </div>
